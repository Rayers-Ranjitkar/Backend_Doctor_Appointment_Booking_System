...
export const assistantChatStore = {
    // Creates a new assistant chat thread in memory
  createChat(auth) {
    ...
    // Lists all assistant chat threads for the user in memory
  listChats(auth) {
    return {
    ...
    // Fetches messages for a specific assistant chat thread in memory
  getChatMessages(threadId, auth) {
    ...
    // Gets recent messages context for AI prompt builder in memory
  getConversationContext(threadId, auth, limit = 12) {
    ...
    // Saves a user prompt message to the thread in memory
  storeUserMessage(threadId, auth, prompt) {
    ...
    // Saves the assistant reply to the thread in memory
  storeAssistantMessage(threadId, auth, assistantReply) {
    ...
    // Deletes an assistant chat thread and its messages from memory
